...
def main():
    print("✨ Seeding LingoTube V6 (Synced Timestamps)...")
    ...
    # Corrected Timestamps (Shifted +12s based on user feedback/visuals)
    # Original: 0-5.5 -> 12-17.5
    # Original: 15-18 -> 27-30
    # Original: 23-28 -> 35-40
    ...
    record = {
        "Title": "Friends: The Ladle Incident (V6 Synced + Audio)",
        "Series": "Friends",
        ...
        "Status": "Done",
        "AI Notes": "V6 Demo: Features + Synced Timestamps (Offset +12s)."
    }
    ...
    if res.status_code == 200:
        print("✅ V6 Synced Demo Seeded!")
    else:
        print(f"❌ V6 Seed failed: {res.text}")
